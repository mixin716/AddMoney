...
public class PhoneAddressAdapter extends BaseAdapter {
	private LayoutInflater inflater;
	private List<AddressBean> list;

	public PhoneAddressAdapter(Context context, List<AddressBean> list) {
		this.list = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.tvAddress.setText(list.get(position).getArea());
		return convertView;
	}
